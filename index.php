...
<body>
    ...
    <table>
		...
		<tr>
            <td></td>
            <td>
                <button type="button" onclick="exampleMyProfile()">
					My Profile</button>
            </td>
        </tr>
		<tr>
            <td></td>
            <td>
                <button type="button" onclick="exampleProfileImage()">
					Image</button>
            </td>
        </tr>
		<tr>
            <td></td>
            <td>
                <button type="button" onclick="exampleMyGrades()">
					Grades</button>
            </td>
        </tr>
				<tr>
            <td></td>
            <td>
                <button type="button" onclick="exampleTOC()">
...
<script type="text/javascript">
	...
	function exampleMyProfile() {
        hideData();
        document.getElementById("GETField").checked = true;
        document.getElementById("actionField").value = "/d2l/api/lp/1.0/profile/myProfile";
    }
	function exampleProfileImage() {
        hideData();
        document.getElementById("GETField").checked = true;
        document.getElementById("actionField").value = "/d2l/api/lp/1.0/profile/myProfile/image";
    }

	function exampleMyGrades() {
        hideData();
        document.getElementById("GETField").checked = true;
        document.getElementById("actionField").value = "/d2l/api/le/1.0/(D2LID: orgUnitId)/grades/values/myGradeValues/";
    }
		function exampleTOC() {
        hideData();
        document.getElementById("GETField").checked = true;
        document.getElementById("actionField").value = "/d2l/api/le/1.0/(D2LID: orgUnitId)/content/toc";
    }
